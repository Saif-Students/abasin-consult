    ...
    <div className="w-full bg-gray-50 py-16 px-6 md:px-16 lg:px-32">
      <div className="max-w-7xl mx-auto">
        ...
        <motion.p 
          ...
          transition={{ duration: 0.8 }}
        >
          At Abasin Consult, we provide expert guidance and innovative solutions to individuals, businesses, and institutions across Pakistan, the UK, Middle East, and Europe. With a team of seasoned professionals and a global network, we help clients navigate complex financial landscapes, achieve strategic objectives, and unlock sustainable growth.
        </motion.p>
        ...
        >
          ...
          <p className="text-lg text-gray-700 leading-relaxed">
            As a global business advisory firm with offices in Pakistan, the UK, Middle East, and Europe, we provide localized expertise and advise on international best practices to clients worldwide.
          </p>
        </motion.div>
