  ...
  return (
    <div className="max-w-5xl mx-auto p-6 lg:p-12 bg-white rounded-lg shadow-xl space-y-10">
      <div className="text-center">
        <h1 className="text-5xl font-extrabold text-gray-900 mb-4">{member.name}</h1>
        <p className="text-xl text-gray-600 italic">{member.title}</p>
      </div>
      ...
      <div className="text-gray-700 space-y-6">
        {member.brief.map((line, index) => (
          <p
            key={index}
            className="text-lg leading-relaxed text-justify lg:text-xl"
          >
            {line}
          </p>
        ))}
        ...
        <div className="text-gray-800">
          ...
          <ul className="list-inside list-disc space-y-3">
            {member.education.map((line, index) => (
              <li
                key={index}
                className="text-lg lg:text-xl leading-relaxed tracking-wide"
              >
                {line}
              </li>
            ))}
        ...
        <div className="text-gray-800">
          ...
          <ul className="list-none space-y-3">
            {member.contact.map((line, index) => (
              <li
                key={index}
                className="flex items-center text-lg lg:text-xl text-blue-600 hover:underline"
              >
      ...
      {/* <div className="text-center">
        <button className="px-6 py-3 bg-indigo-600 text-white rounded-full text-lg shadow-md hover:bg-indigo-700 hover:shadow-lg transition duration-300">
          Get in Touch
        </button>
      </div> */}
    </div>
